...
SilphCo2F_Object:
	...
	warp_event 27, 10, SILPH_CO_3F, 1
	...
	object_event 22,  5, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO2F_SCIENTIST1, OPP_SCIENTIST, 2
	object_event 21,  7, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO2F_SCIENTIST2, OPP_SCIENTIST, 3
	object_event 21, 14, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO2F_ROCKET1, OPP_ROCKET, 23
