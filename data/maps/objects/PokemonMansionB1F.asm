...
PokemonMansionB1F_Object:
	...
	def_object_events
	object_event 17, 24, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_POKEMONMANSIONB1F_BURGLAR, OPP_BURGLAR, 9
	object_event 20,  6, SPRITE_SCIENTIST, STAY, DOWN, TEXT_POKEMONMANSIONB1F_SCIENTIST, OPP_SCIENTIST, 13
