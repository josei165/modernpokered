...
SilphCo4F_Object:
	...
	warp_event 16, 13, SILPH_CO_5F, 2
	...
	object_event 18, 13, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO4F_ROCKET1, OPP_ROCKET, 26
	object_event 20,  3, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO4F_SCIENTIST, OPP_SCIENTIST, 5
	object_event 23,  3, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO4F_ROCKET2, OPP_ROCKET, 27
