...
SilphCo7F_Object:
	...
	object_event 19,  1, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO7F_ROCKET1, OPP_ROCKET, 32
	object_event 18,  1, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO7F_SCIENTIST, OPP_SCIENTIST, 8
	object_event 21,  1, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO7F_ROCKET2, OPP_ROCKET, 33
	object_event 20,  1, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO7F_ROCKET3, OPP_ROCKET, 34
