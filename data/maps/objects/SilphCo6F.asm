...
SilphCo6F_Object:
	...
	def_warp_events
	warp_event 13, 14, SILPH_CO_7F, 2
	...
	object_event  6,  3, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO6F_ROCKET1, OPP_ROCKET, 30
	object_event  7,  2, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO6F_SCIENTIST, OPP_SCIENTIST, 7
	object_event  7,  6, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO6F_ROCKET2, OPP_ROCKET, 31
