...
Route20_Object:
	...
	def_object_events
	object_event 35, 16, SPRITE_SWIMMER, STAY, UP, TEXT_ROUTE20_SWIMMER1, OPP_SWIMMER, 9
	object_event 33, 16, SPRITE_SWIMMER, STAY, UP, TEXT_ROUTE20_SWIMMER2, OPP_BEAUTY, 15
	object_event 22, 14, SPRITE_SWIMMER, STAY, DOWN, TEXT_ROUTE20_SWIMMER3, OPP_BEAUTY, 6
	object_event 26, 14, SPRITE_SWIMMER, STAY, DOWN, TEXT_ROUTE20_SWIMMER4, OPP_JR_TRAINER_F, 24
	object_event 18, 14, SPRITE_SWIMMER, STAY, DOWN, TEXT_ROUTE20_SWIMMER5, OPP_SWIMMER, 10
	object_event 34, 16, SPRITE_SWIMMER, STAY, UP, TEXT_ROUTE20_SWIMMER6, OPP_SWIMMER, 11
	object_event 15, 16, SPRITE_SWIMMER, STAY, UP, TEXT_ROUTE20_COOLTRAINER_M, OPP_BIRD_KEEPER, 11
