...
PokemonMansion3F_Object:
	...
	def_object_events
	object_event 13,  8, SPRITE_SUPER_NERD, STAY, RIGHT, TEXT_POKEMONMANSION3F_SUPER_NERD, OPP_BURGLAR, 8
	object_event 14, 10, SPRITE_SCIENTIST, STAY, LEFT, TEXT_POKEMONMANSION3F_SCIENTIST, OPP_SCIENTIST, 12
