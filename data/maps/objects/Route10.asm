...
Route10_Object:
	...
	def_object_events
	object_event 10, 68, SPRITE_SUPER_NERD, STAY, RIGHT, TEXT_ROUTE10_SUPER_NERD1, OPP_POKEMANIAC, 1
	object_event  3, 57, SPRITE_HIKER, STAY, UP, TEXT_ROUTE10_HIKER1, OPP_HIKER, 7
	object_event 11, 65, SPRITE_SUPER_NERD, STAY, LEFT, TEXT_ROUTE10_SUPER_NERD2, OPP_POKEMANIAC, 2
	...
	object_event  6, 40, SPRITE_GUARD, STAY, DOWN, TEXT_ROUTE10_GUARD
