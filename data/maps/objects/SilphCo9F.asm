...
SilphCo9F_Object:
	...
	warp_event 21, 15, SILPH_CO_10F, 7

	def_bg_events

	def_object_events
	object_event  3, 14, SPRITE_NURSE, STAY, DOWN, TEXT_SILPHCO9F_NURSE
	object_event 16,  3, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO9F_ROCKET1, OPP_ROCKET, 37
	object_event 15,  1, SPRITE_SCIENTIST, STAY, RIGHT, TEXT_SILPHCO9F_SCIENTIST, OPP_SCIENTIST, 10
	object_event 15,  3, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO9F_ROCKET2, OPP_ROCKET, 38
