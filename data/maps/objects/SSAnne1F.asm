...
SSAnne1F_Object:
	...
	warp_event 31,  9, SS_ANNE_1F_ROOMS, 1
	warp_event 23,  9, SS_ANNE_1F_ROOMS, 2
	warp_event 19,  9, SS_ANNE_1F_ROOMS, 3
	warp_event 15,  9, SS_ANNE_1F_ROOMS, 4
	warp_event 11,  9, SS_ANNE_1F_ROOMS, 5
	warp_event  7,  9, SS_ANNE_1F_ROOMS, 6
	warp_event  2,  6, SS_ANNE_2F, 7
	warp_event 37, 15, SS_ANNE_B1F, 6
	warp_event  3, 16, SS_ANNE_KITCHEN, 1
	warp_event 28, 12, SS_ANNE_2F_ROOMS, 15
