...
SSAnne1FRooms_Object:
	...
	def_warp_events
	warp_event  6,  0, SS_ANNE_1F, 3
	warp_event  7,  0, SS_ANNE_1F, 4
	warp_event  8,  0, SS_ANNE_1F, 5
	warp_event 10,  8, SS_ANNE_1F, 6
	warp_event 11,  8, SS_ANNE_1F, 7
	warp_event 12,  8, SS_ANNE_1F, 8
	warp_event  0,  2, SS_ANNE_2F_ROOMS, 14
	warp_event 11,  3, SS_ANNE_B1F_ROOMS, 11

	def_bg_events

	def_object_events
	object_event  7,  4, SPRITE_GENTLEMAN, STAY, LEFT, TEXT_SSANNE1FROOMS_GENTLEMAN1, OPP_GENTLEMAN, 1
	object_event 13,  3, SPRITE_GENTLEMAN, STAY, UP, TEXT_SSANNE1FROOMS_GENTLEMAN2, OPP_GENTLEMAN, 2
	object_event 11, 13, SPRITE_YOUNGSTER, STAY, UP, TEXT_SSANNE1FROOMS_YOUNGSTER, OPP_YOUNGSTER, 8
	object_event 17, 11, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_SSANNE1FROOMS_COOLTRAINER_F, OPP_LASS, 11
