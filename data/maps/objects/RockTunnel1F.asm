...
RockTunnel1F_Object:
	...
	def_object_events
	object_event  6,  5, SPRITE_HIKER, STAY, LEFT, TEXT_ROCKTUNNEL1F_HIKER1, OPP_HIKER, 12
	object_event  6, 18, SPRITE_HIKER, STAY, DOWN, TEXT_ROCKTUNNEL1F_HIKER2, OPP_HIKER, 13
	...
	object_event 34, 24, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROCKTUNNEL1F_COOLTRAINER_F3, OPP_JR_TRAINER_F, 19
