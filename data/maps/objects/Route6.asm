...
Route6_Object:
	...
	def_object_events
	object_event 10, 23, SPRITE_COOLTRAINER_M, STAY, UP, TEXT_ROUTE6_COOLTRAINER_M1, OPP_JR_TRAINER_M, 4
	object_event 11, 23, SPRITE_COOLTRAINER_F, STAY, UP, TEXT_ROUTE6_COOLTRAINER_F1, OPP_JR_TRAINER_F, 2
	object_event 15, 14, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_ROUTE6_YOUNGSTER1, OPP_BUG_CATCHER, 10
	...
	object_event 17, 26, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_ROUTE6_YOUNGSTER2, OPP_BUG_CATCHER, 11
