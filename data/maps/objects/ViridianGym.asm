...
ViridianGym_Object:
	...
	object_event 11, 10, SPRITE_HIKER, STAY, UP, TEXT_VIRIDIANGYM_HIKER1, OPP_BLACKBELT, 6
	...
	object_event  9,  1, SPRITE_HIKER, STAY, DOWN, TEXT_VIRIDIANGYM_HIKER3, OPP_BLACKBELT, 8
	object_event  2, 16, SPRITE_ROCKER, STAY, LEFT, TEXT_VIRIDIANGYM_ROCKER2, OPP_TAMER, 4
	object_event  6, 10, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_VIRIDIANGYM_COOLTRAINER_M3, OPP_COOLTRAINER_M, 1
