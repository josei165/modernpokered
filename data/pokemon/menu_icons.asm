MonPartyData:
	...
	nybble ICON_MON       ; RattataA
	nybble ICON_MON       ; RaticateA
	nybble ICON_MON       ; RaichuA
	nybble ICON_MON       ; SandshrewA
	nybble ICON_MON       ; SandslashA
	nybble ICON_MON       ; VulpixA
	nybble ICON_MON       ; NinetalesA
	...
	nybble ICON_MON       ; ExeggutorA
	nybble ICON_MON       ; MarowakA
	nybble ICON_MON       ; MeowthG
	nybble ICON_MON       ; Perrserker
	nybble ICON_MON       ; GrowlitheH
	nybble ICON_MON       ; ArcanineH
	nybble ICON_MON       ; PonytaG
	nybble ICON_MON       ; RapidashG
	nybble ICON_MON       ; SlowpokeG
	nybble ICON_MON       ; SlowbroG
	nybble ICON_MON       ; SlowkingG
	nybble ICON_MON       ; FarfetchdG
	nybble ICON_MON       ; Sirfetch'd
	nybble ICON_MON       ; VoltorbH
	nybble ICON_MON       ; ElectrodeH
	nybble ICON_MON       ; WeezingG
	nybble ICON_MON       ; Mr.MimeG
	nybble ICON_MON       ; Mr.Rime
	nybble ICON_MON       ; Kleavor
	nybble ICON_MON       ; ArticunoG
	nybble ICON_MON       ; ZapdosG
	nybble ICON_MON       ; MoltresG
	nybble ICON_MON       ; Annihilape
	nybble ICON_MON       ; TaurosC
	nybble ICON_MON       ; TaurosB
	nybble ICON_MON       ; TaurosA
