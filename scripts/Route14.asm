...
Route14TrainerHeader3:
	trainer EVENT_BEAT_ROUTE_14_TRAINER_3, 1, Route14CooltrainerM4BattleText, Route14CooltrainerM4EndBattleText, Route14CooltrainerM4AfterBattleText
...
Route14TrainerHeader5:
	trainer EVENT_BEAT_ROUTE_14_TRAINER_5, 3, Route14CooltrainerM6BattleText, Route14CooltrainerM6EndBattleText, Route14CooltrainerM6AfterBattleText
